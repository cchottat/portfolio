  ...
  <nav class="sticky top-0 z-40 bg-white border-b-2 border-black py-4">
    <div class="max-w-7xl mx-auto px-6 flex justify-between items-center">
      ...
      <div class="hidden md:flex items-center gap-8 font-body font-bold text-lg uppercase tracking-wide">
        ...
        <a href="mailto:hottatclara@gmail.com" class="bg-black text-white px-6 py-2 rounded-full font-bold hover:bg-pop-raspberry hover:scale-105 transition-all border-2 border-transparent hover:border-black">
          Me Contacter
        </a>
      </div>
      ...
      >
        ...
        <div class="flex-grow flex flex-col items-center justify-center gap-10 w-full text-center px-4">
            <RouterLink 
            v-for="link in links" 
            :key="link.name" 
            :to="link.path"
            ...
            class="font-retro text-5xl uppercase text-black hover:text-pop-orange transition-all block"
            >
            {{ link.name }}
            </RouterLink>
